# ============================================================
# Run STURM residential scenarios (global only) for BMT linking
# ============================================================
...
# MESSAGE linking outputs (resid_sturm_<scenario>.csv)
...
input_list_file <- "input_list_resid_2026_05_18_CE.csv"

...
scenarios <- c(
  "EU_exogenous" = "Baseline exogenous",
  "EU_endogenous" = "Baseline endogenous",
  "EU_strong_endogenous" = "Strong additional policies",
  "EU_medium_endogenous" = "Medium additional policies")
```
...
plot_variable_evolution(data,
                        ...
                        y_label = y_label,
                        subplot = FALSE,
                        save_path = paste(save_dir, "heat_evolution.png",
                          sep="/")
)
```

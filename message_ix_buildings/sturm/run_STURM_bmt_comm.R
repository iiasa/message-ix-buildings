...
#   default:  Rscript run_STURM_bmt_comm.R
#   private:  Rscript run_STURM_bmt_comm.R --data=private  (configure via setup_sturm_local_data.R)
...
for(s in scenarios){
  ...
  sturm_scenarios <- run_scenario(run = s,
                                  ...
                                  file_inputs = "input_list_comm_2026_05_18_CE.csv",

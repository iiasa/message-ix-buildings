...
```{r}
scenario <- "EU_implementation_nomfhq1rent"
...
plot_stacked_area(data, "year", "stock_M", "fuel_heat",
                  ...
                  save_path = paste(save_dir, paste0(scenario, "_stock_hh_fuel.png"), sep = "/"))
```
...
plot_stacked_area(data, "year", "heat_ktoe", "fuel_heat",
                  ...
                  save_path = paste(save_dir, paste0(scenario, "_heating_fuel.png"), sep = "/")
                  )
```

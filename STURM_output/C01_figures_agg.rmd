...
```{r}
scenario <- "EU_price_constant_exogenous"
...
make_plot_lines(temp, var, ref, path)
```
...
### Share fuel heat and efficiency in total stock
```{r}
source("STURM_output/C00_plots.R")
...
### Share fuel heat and efficiency in total energy demand
```{r}
source("STURM_output/C00_plots.R")

# GLANCE runner placehoder
# For now it takes the ACCESS cook/appliances and other fixed exogenous demands, 
# then applies a constant-elasticity demand response.
...
if (length(missing)) {
  stop(
    ...
    "\nAdd access_cook.csv, access_app.csv, input_prices_R12.csv, ",

...
# Working directory: RStudio vs Rscript (Python/mix-models runs `Rscript run_STURM_bmt_comm.R` with cwd=sturm)
if (requireNamespace("rstudioapi", quietly = TRUE) && rstudioapi::isAvailable()) {
  ...
  if (length(file_arg)) {
    ...
    stop("Cannot set working directory: run from RStudio, or `Rscript run_STURM_bmt_comm.R` from the sturm folder.")
  }
}

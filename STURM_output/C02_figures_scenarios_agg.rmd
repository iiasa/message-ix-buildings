...
if (run_test) {
    ...
    scenarios <- c(
        ...
        "EU_ambitious_heat" = "Subsidies 80 hp",
        "EU_carbon_tax_medium"  = "Carbon tax medium",
        "EU_carbon_tax_ambitious" = "Carbon tax ambitious",
        "EU_carbon_tax" = "Carbon tax",
        "EU_carbon_tax_policies" = "Carbon tax and policies"
      )
    scenarios <- c(
      "EU" = "Baseline",
      "EU_carbon_tax" = "Carbon tax",
...
colors_scenarios <- c(
  ...
  "Carbon tax" = "#fdbb40",
  "Carbon tax medium" = "#fdbb40",
  "Carbon tax ambitious" = "#4f3608",
  "1p5C" = "#fdbb40",
...
plot_multiple_lines(filter(temp, region_bld == "EU"),
    ...
    group_column = NULL,
    ncol = 4,
    y_label = "Residential space heating emission Scope 2 in EU\nMtCO2",
    free_y = TRUE,
    line_types = line_styles_scenarios,
    colors_lines = colors_scenarios,
    save_path = paste(save_dir,

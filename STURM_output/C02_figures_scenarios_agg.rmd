...
scenarios <- c(
    ...
    # "EU_ambitious_heat_constant" = "Ambitious heat-pumps",
    "EU_ambitious_shell_constant" = "Ambitious renovation"
)
run <- "test"
scenarios <- c(
  "EU_exogenous" = "Baseline",
  "EU_no_exogenous" = "No renovation",
  "EU_double_exogenous" = "Double renovation",
  "EU_triple_exogenous" = "Triple renovation"
)
colors_scenarios <- c(
  "Baseline" = "#00589d",
  ...
  "Double renovation" = "#62c5c0",
  "Triple renovation" = "#ee6a6b"
  )
